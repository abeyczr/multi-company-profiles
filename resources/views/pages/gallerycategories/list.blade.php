...
<?php
    ...
    $pageTitle = "Gallery Categories"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Gallery Categories</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("gallerycategories/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="gallerycategories-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/gallerycategories/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left table-bordered">
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentEnd-->
                                        <td class="td-btn">
                                            <a class="btn btn-sm btn-primary has-tooltip page-modal"    href="<?php print_link("gallerycategories/view/$rec_id"); ?>" >
                                            <i class="icon dripicons-preview"></i> 
                                        </a>
                                        <a class="btn btn-sm btn-success has-tooltip page-modal"    href="<?php print_link("gallerycategories/edit/$rec_id"); ?>" >
                                        <i class="icon dripicons-document-edit"></i> 
                                    </a>
                                    <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Apakah anda yakin akan menghapus data ini?" data-display-style="modal"  href="<?php print_link("gallerycategories/delete/$rec_id"); ?>" >
            ...
            <div class=" mt-3">
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto d-flex">    
                        <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("gallerycategories/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
