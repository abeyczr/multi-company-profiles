...
<?php
    $pageTitle = "Add New Gallery"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Gallery</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="galleries-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('galleries.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-caption-holder" class=" ">
                                                <input id="ctrl-caption" data-field="caption"  value="<?php echo get_value('caption', "NULL") ?>" type="text" placeholder="Enter Caption"  name="caption"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
