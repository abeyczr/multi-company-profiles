...
<?php
    ...
    $pageTitle = "Galleries"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Galleries</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <a  class="btn btn-primary btn-block" href="<?php print_link("galleries/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="galleries-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/galleries/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left table-bordered">
                                <thead class="table-header bg-primary text-white">
                                    <tr>
                                        ...
                                        <?php Html :: get_field_order_link('image', "Image", ''); ?>
                                        </th>
                                        <th class="td-caption <?php echo (get_value('orderby') == 'caption' ? 'sortedby' : null); ?>" >
                                        <?php Html :: get_field_order_link('caption', "Caption", ''); ?>
                                        </th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("/galleries/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                                    ...
                                    <td class="td-category_id">
                                        <a size="sm" class="btn btn-sm btn btn-secondary page-modal" href="<?php print_link("gallerycategories/view/$data[category_id]?subpage=1") ?>">
                                        <i class="icon dripicons-preview"></i> <?php echo $data['gallerycategories_name'] ?>
                                    </a>
                                </td>
                                <td class="td-image">
                                    <?php 
                                ...
                                <!--PageComponentEnd-->
                                <td class="td-btn">
                                    <a class="btn btn-sm btn-primary has-tooltip page-modal"    href="<?php print_link("galleries/view/$rec_id"); ?>" >
                                    <i class="icon dripicons-preview"></i> 
                                </a>
                                <a class="btn btn-sm btn-success has-tooltip page-modal"    href="<?php print_link("galleries/edit/$rec_id"); ?>" >
                                <i class="icon dripicons-document-edit"></i> 
                            </a>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Apakah anda yakin akan menghapus data ini?" data-display-style="modal"  href="<?php print_link("galleries/delete/$rec_id"); ?>" >
    ...
    <div class=" mt-3">
        <div class="row align-items-center justify-content-between">    
            <div class="col-md-auto d-flex">    
                <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("galleries/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
