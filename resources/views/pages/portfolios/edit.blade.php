...
<?php
    $pageTitle = "Edit Portfolio"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Portfolio</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("portfolios/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-project_year-holder" class=" ">
                                            <input id="ctrl-project_year" data-field="project_year"  value="<?php  echo $data['project_year']; ?>" type="text" placeholder="Enter Project Year"  name="project_year"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-client_name-holder" class=" ">
                                            <input id="ctrl-client_name" data-field="client_name"  value="<?php  echo $data['client_name']; ?>" type="text" placeholder="Enter Client Name"  name="client_name"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
