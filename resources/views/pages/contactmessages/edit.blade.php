...
<?php
    $pageTitle = "Edit Contact Message"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Contact Message</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("contactmessages/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-subject-holder" class=" ">
                                            <input id="ctrl-subject" data-field="subject"  value="<?php  echo $data['subject']; ?>" type="text" placeholder="Enter Subject"  name="subject"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-message-holder" class=" ">
                                            <textarea placeholder="Enter Message" id="ctrl-message" data-field="message"  rows="5" name="message" class=" form-control"><?php  echo $data['message']; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-is_read-holder" class=" ">
                                            <input id="ctrl-is_read" data-field="is_read"  value="<?php  echo $data['is_read']; ?>" type="number" placeholder="Enter Is Read" step="any"  required="" name="is_read"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
