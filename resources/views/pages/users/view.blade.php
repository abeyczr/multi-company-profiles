                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="page-data">
                                ...
                                <div class="mb-3 row row justify-content-start g-0">
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Remember Token</small>
                                                    <div class="fw-bold">
                                ...
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Apakah anda yakin akan menghapus data ini?" data-display-style="modal"  href="<?php print_link("users/delete/$rec_id?redirect=users"); ?>" >
