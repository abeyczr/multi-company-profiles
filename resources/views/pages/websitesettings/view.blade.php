...
<?php
    $pageTitle = "Website Setting Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Website Setting Details</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                                    ...
                                    <div class="bg-light mb-1 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <div class="fw-bold">
                                                    <?php echo  $data['maintenance_mode'] ; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a class="btn btn-sm btn-success has-tooltip "    href="<?php print_link("websitesettings/edit/$rec_id"); ?>" >
                                <i class="icon dripicons-document-edit"></i> Edit
                            </a>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Apakah anda yakin akan menghapus data ini?" data-display-style="modal"  href="<?php print_link("websitesettings/delete/$rec_id?redirect=websitesettings"); ?>" >
