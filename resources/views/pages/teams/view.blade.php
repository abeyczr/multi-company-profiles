...
<?php
    $pageTitle = "Team Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Team Details</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class=" page-content" >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a class="btn btn-sm btn-success has-tooltip "    href="<?php print_link("teams/edit/$rec_id"); ?>" >
                                <i class="icon dripicons-document-edit"></i> Edit
                            </a>
                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Apakah anda yakin akan menghapus data ini?" data-display-style="modal"  href="<?php print_link("teams/delete/$rec_id?redirect=teams"); ?>" >
